...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka/Packages.json' -folder $tmpFolder | Out-Null
