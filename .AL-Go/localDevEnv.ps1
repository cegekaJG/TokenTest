...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go/publish-testmaster/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go/publish-testmaster/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go/publish-testmaster/Actions/Packages.json' -folder $tmpFolder | Out-Null
